...
# NOTE: doc_reps/claim_reps point at the modernbert-base.cover-5k shards built by
# scripts/dense-index/modernbert-base.cover-5k/neuclir1-encode-{docs,claims}.sh.
...
# shard rather than the full claims_emb corpus -- see src/retrieval/dc_gap_dense.py's _load_reps.
