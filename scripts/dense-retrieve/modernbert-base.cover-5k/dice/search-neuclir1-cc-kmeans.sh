...
#SBATCH --output=logs/search-neuclir1-dice.out
#SBATCH --error=logs/search-neuclir1-dice.err
...
# Same grid as scripts/dense-retrieve/Qwen3-Embedding-0.6B/divrerank/search-neuclir1-cc-kmeans.sh,
