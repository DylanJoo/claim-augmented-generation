...
def run(topics, n_questions=10, model_name_or_path="Qwen/Qwen3-8B") -> List[Result]:

    llm = LLM(model_name_or_path=model_name_or_path,
              dtype="half",
              temperature=0.7,
              top_p=0.8,
              top_k=20,
