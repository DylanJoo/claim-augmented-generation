"""Remote-retrieval pipeline: uses a remote RRF-fusion HTTP service instead of local BM25.
"""
import sys
import os
...
from retrieval import remote as retrieval_ss
...
#
# # 2. Retrieval: remote RRF-fusion service over claim index
